...
| 2 | Approvals are in-memory: they do not survive a restart and are not shared between workers | High | stated in the module, in the 404 message and in the README. Needs a database + audit log, which is a legal design task first |
